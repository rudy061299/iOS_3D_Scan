...
@available(iOS 11.1, *)
class FaceScanViewController: UIViewController, AVCaptureDataOutputSynchronizerDelegate {
...
//
//            print("Video: width")
//            print(CVPixelBufferGetWidth(videoFrame))
//
//            print("Video: height")
//            print(CVPixelBufferGetHeight(videoFrame))
            ...
            print("Texture point")
            let temp = CGPoint(x: texturePoint.x, y: texturePoint.y)
            print(temp)
